...
type Home = {
  readonly hero: { heading: string; paragraph: string; text: string; path: string; image: string; };
  readonly subhero: { heading: string; paragraph: string; image: string; };
  readonly featuresgrid: { heading: string; paragraph: string; features: { heading: string; paragraph: string; image: string; }[]; };
